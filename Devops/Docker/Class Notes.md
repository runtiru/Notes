...
# What is KUBERNETES (K8s)..?
    ...
    - An open-source system fot automating deployment, scaling, and management of containerized applictions.
...
* isolations are created with the help of namespaces
  the limitations or restrictions on isolated areas can be acheive using control groups.
    ...
    3. Net namespace - network istolation
        * its created 2 network interphases
                - eth0 (Ethernet)
                - lo (Loopback)

    4. User namespace (url) new set of your pc
...
* create an instance (ec2-ubuntu 22.)
  search 'docker installation script'

```bash
1. Download the script
curl -fsSL <https://get.docker.com> -o install-docker.sh

2. Run the script either as root (or) using sudo perform
